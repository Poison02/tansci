package cdu.zch.tansci.common.aop;
...
import cdu.zch.tansci.utils.IPUtils;
...
public class LogAspect {
     ...
     * @editNote：
     */
    @Pointcut("@annotation(cdu.zch.tansci.common.annotation.Log)")
     ...
     * @editNote：
     */
    @Pointcut("execution(* cdu.zch.tansci.controller..*.*(..))")
