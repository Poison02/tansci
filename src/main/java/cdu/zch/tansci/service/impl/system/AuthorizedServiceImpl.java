...
import cdu.zch.tansci.config.AuthorizedConfig;
...
import cdu.zch.tansci.service.impl.message.WebSocketServer;
import cdu.zch.tansci.service.system.AuthorizedService;
import cdu.zch.tansci.service.system.SysUserRoleService;
import cdu.zch.tansci.service.system.SysUserService;
import cdu.zch.tansci.utils.JwtTokenUtils;
import cdu.zch.tansci.utils.QRCodeUtils;
import cdu.zch.tansci.utils.UUIDUtils;
    ...
    public void wxCallback(String code, String state) {
        ...
        if (Objects.isNull(user)) {
            ...
            user = SysUser.builder()
                    ...
                    .delFlag(Constants.NOT_DEL_FLAG)
                    .remarks("微信扫描注册用户")
                    .build();
