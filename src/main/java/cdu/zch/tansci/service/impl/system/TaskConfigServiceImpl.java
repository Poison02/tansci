...
import cdu.zch.tansci.common.task.ScheduledTask;
import cdu.zch.tansci.domain.system.TaskConfig;
import cdu.zch.tansci.domain.system.dto.TaskConfigDto;
import cdu.zch.tansci.mapper.system.TaskConfigMapper;
...
public class TaskConfigServiceImpl extends ServiceImpl<TaskConfigMapper, TaskConfig> implements TaskConfigService {
    ...
    public IPage<TaskConfig> page(Page page, TaskConfigDto dto) {
        ...
        iPage.getRecords().forEach(item -> {
            item.setStatusName(Enums.getValueByGroup(item.getStatus(), "status"));
        });
        return iPage;
    }
